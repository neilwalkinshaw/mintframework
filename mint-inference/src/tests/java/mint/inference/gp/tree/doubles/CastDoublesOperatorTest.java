...
public class CastDoublesOperatorTest {
    ...
    public void testCastDouble() throws InterruptedException {
        ...
        DoubleVariableAssignmentTerminal ivt = new DoubleVariableAssignmentTerminal(iv, false);
    ...
    public void testCastInteger() throws InterruptedException {
        ...
        IntegerVariableAssignmentTerminal ivt = new IntegerVariableAssignmentTerminal(iv, false);
