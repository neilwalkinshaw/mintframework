...
public class GPTester {
    ...
    public void testLimitedAll() {
        ...
        SingleOutputGP gp = new SingleOutputGP(gpGenerator, generateTrainingSet(100),new GPConfiguration(200,0.9,0.1,5,20), false);
    ...
    public void testBooleanGP() {
        ...
        SingleOutputGP gp = new SingleOutputGP(gpGenerator, generateBooleanTrainingSet(50),new GPConfiguration(100,0.95,0.05,7,10));
    ...
    private Map<List<VariableAssignment<?>>,VariableAssignment<?>> generateBooleanTrainingSet(int size) {
        Map<List<VariableAssignment<?>>,VariableAssignment<?>> trainingSet = new HashMap<List<VariableAssignment<?>>,VariableAssignment<?>>();
        Random r = new Random(0);
        for(int i = 0; i< size; i++){
            List<VariableAssignment<?>> inputs = new ArrayList();
